...
export function CTASection() {
  return (
    <section className="px-4 sm:px-6 py-16 md:py-24 border-t border-border">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        <p className="text-[11px] font-semibold tracking-[0.12em] uppercase text-foreground-muted mb-6 font-sans">
          Empieza ahora
        </p>
        <h2 className="font-serif text-3xl md:text-4xl lg:text-6xl font-medium text-foreground mb-6 leading-tight max-w-2xl">
